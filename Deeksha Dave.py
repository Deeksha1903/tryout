...
wb=xl.Workbooks('SynthData.xlsx')
...
'''Pma=getdata(sheet,"A3[0]")
a=getdata(sheet,"B3[0]")
Pmb=getdata(sheet,"C3[0]")
nf=getdata(sheet,"D3[0]")
Pp=getdata(sheet,"E3[0]")
Pf=getdata(sheet,"F3[0]")
theta=getdata(sheet,"G3[0]")
r=getdata(sheet,"H3[0]")
xfa=getdata(sheet,"I3[0]")
L=getdata(sheet,"J3[0]")'''
